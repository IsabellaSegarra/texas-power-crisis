...
st_layers(here("data", "gis_osm_buildings_a_free_1.gpkg"))
...
tm_shape(nl_07_crop) +
  tm_raster(breaks = c(2000, 4000, 6000, 8000)) 
...
# MAKE PRINT STATMENT CONNFIRIMING THE UNITS 
st_crs(roads)$units
...
# find areas that experienced blackouts that are further than 200 m  
  # can use st_disjoin and st_difference 


st_difference(blackout, highways) 
