...
buildings_blackout2 <- st_join(houses, blackout_highways, join = st_intersects, left = TRUE)
# NEW WORKFLOW 
buildings_blackout <- houses[blackout_highways, op = st_intersects]
# number of buildings 
nrow(buildings_blackout)
...
residential_blackout <- buildings_blackout2 %>% 
...
buildings_no_blackout <- buildings_blackout2 %>% #running slow, dropping geom
...
st_join(x = acs, y = non_affeted_homes, join = st_intersects)
st_join(x = acs, y = affeted_homes, join = st_intersects)
