...
nl_07_map <- tm_shape(nl_07_crop) +
  tm_raster(palette = gray.colors(10), 
            style = "cont",
            title = "Light Intensity (units)") + 
  tm_title("Houston, Texas Night Lights 02-07-2021", fontface = "bold") +
  tm_title("SUBTITLE", size = 0.8) +
  tm_layout(bg.color = "white") 

#......Mapping 2021-02-16......

nl_16_map <- tm_shape(nl_07_crop) +
  tm_raster(palette = gray.colors(10), 
            style = "cont",
            title = "Light Intensity (units)") + 
  tm_title("Houston, Texas Night Lights 02-16-2021", fontface = "bold") +
  tm_title("SUBTITLE", size = 0.8) +
  tm_layout(bg.color = "white") 

# Arrange both maps
tmap_arrange(nl_07_map, nl_16_map, nrow = 1) 
...
# get homes that experienced blackout 

# The CRS of 'roads' needs to be transformed to the Texas CRS
houses <- st_transform(houses, crs = "EPSG:3083")

buildings_blackout <- st_within(blackout_highways, houses) 
...
left_join(socioeco_income, socioeco_geom, by = "GEOID")
