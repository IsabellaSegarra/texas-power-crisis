...
# Merge night light 07 
nl_07 <- merge(nl_05_07_rast, nl_06_07_rast)

nl_16 <- merge(nl_05_16_rast, nl_06_16_rast)

dif_nl <- nl_16 - nl_07 > 200 # this will produce a conditional and any object that is an NA is more than 200 
...
# DO alter 
nl_16 <- rast(xmin = -113.3, xmax = -113, ymin = 37.2, ymax = 37.9,
            resolution = 0.3,
            vals = 1)
